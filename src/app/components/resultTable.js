        ...
        <thead>
          ...
          <tr className="bg-gray-800/40">
            <th className="relative flex justify-start gap-2 px-6 py-4 text-left text-gray-300 font-medium border-b border-gray-700">
              Keyword
              <span className="absolute right-10 info transfrom-translate-y-1/2 text-gray-400 cursor-pointer  z-20">
                ?
                <span className="tooltip absolute top-full mt-2 w-64 bg-gray-800 text-white text-sm rounded-md shadow-lg p-2 hidden ">
                  cette colonne représente les mots clés.
                </span>
                </span>
            </th>
            <th className="relative px-6 py-4 text-center text-gray-300 font-medium border-b border-gray-700">
              Monthly Searches
               <span className="absolute right-5 info transfrom-translate-y-1/2 text-gray-400 cursor-pointer  z-20">
                ?
                <span className="tooltip absolute top-full mt-2 w-64 bg-gray-800 text-white text-sm rounded-md shadow-lg p-2 hidden ">
                  cette colonne représente le nombre de recherches mensuelles.
                </span>
                </span>
            </th>
            <th className="relative px-6 py-4 text-center text-gray-300 font-medium border-b border-gray-700">
            <span className="absolute right-5 info transfrom-translate-y-1/2 text-gray-400 cursor-pointer  z-20">
                ?
                <span className="tooltip absolute top-full mt-2 w-64 bg-gray-800 text-white text-sm rounded-md shadow-lg p-2 hidden ">
                  cette colonne représente la compétition des mots clés.
                </span>
                </span>
              Competition
            </th>
            ...
            <span className="absolute right-5 info transfrom-translate-y-1/2 text-gray-400 cursor-pointer  z-20">
                ?
                <span className="tooltip absolute left-0 top-full mt-2 w-64 bg-gray-800 text-white text-sm rounded-md shadow-lg p-2 hidden ">
                  cette colonne les suggestions de mots clés avec le recherche mensuel et la compétition.
                </span>
                </span>
              Suggestions
            </th>
